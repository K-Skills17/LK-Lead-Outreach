-- ============================================
-- ADVANCED FEATURES MIGRATION (FIXED)
-- Personalization, Optimal Send Time, A/B Testing
-- ============================================

-- Drop any existing views that might conflict with table names
DROP VIEW IF EXISTS optimal_send_times CASCADE;
DROP VIEW IF EXISTS lead_personalization CASCADE;
DROP VIEW IF EXISTS send_time_analytics CASCADE;
DROP VIEW IF EXISTS ab_test_campaigns CASCADE;
DROP VIEW IF EXISTS ab_test_assignments CASCADE;
DROP VIEW IF EXISTS ab_test_events CASCADE;
...
CREATE INDEX IF NOT EXISTS idx_lead_personalization_contact ON lead_personalization(contact_id);
CREATE INDEX IF NOT EXISTS idx_lead_personalization_tier ON lead_personalization(lead_tier);
CREATE INDEX IF NOT EXISTS idx_lead_personalization_score ON lead_personalization(personalization_score);
...
CREATE INDEX IF NOT EXISTS idx_optimal_send_times_contact ON optimal_send_times(contact_id);
CREATE INDEX IF NOT EXISTS idx_optimal_send_times_send_at ON optimal_send_times(optimal_send_at);
CREATE INDEX IF NOT EXISTS idx_optimal_send_times_batch ON optimal_send_times(batch_id) WHERE batch_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_optimal_send_times_business_type ON optimal_send_times(business_type);
...
CREATE INDEX IF NOT EXISTS idx_send_time_analytics_time ON send_time_analytics(day_of_week, hour_of_day);
CREATE INDEX IF NOT EXISTS idx_send_time_analytics_niche ON send_time_analytics(niche) WHERE niche IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_send_time_analytics_business_type ON send_time_analytics(business_type) WHERE business_type IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_send_time_analytics_open_rate ON send_time_analytics(open_rate DESC);
...
CREATE INDEX IF NOT EXISTS idx_ab_test_campaigns_campaign ON ab_test_campaigns(campaign_id);
CREATE INDEX IF NOT EXISTS idx_ab_test_campaigns_status ON ab_test_campaigns(status);
...
CREATE INDEX IF NOT EXISTS idx_ab_test_assignments_contact ON ab_test_assignments(contact_id);
CREATE INDEX IF NOT EXISTS idx_ab_test_assignments_variant ON ab_test_assignments(test_id, variant_name);
...
CREATE INDEX IF NOT EXISTS idx_ab_test_events_occurred ON ab_test_events(occurred_at);
