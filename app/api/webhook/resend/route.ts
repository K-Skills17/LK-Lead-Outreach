 ...
 * 
 * Note: We duplicate the handler here because Next.js doesn't allow importing route handlers directly
 */
 ...
 * 
 * This is an alias for /api/webhooks/resend (plural path)
 */
